...
This project was bootstrapped and restructured with [Create Redux App](https://github.com/jonidelv/generator-create-redux-app). Here you can find information on how to perform common tasks.


## Installation

First, install [Yarn](https://yarnpkg.com) ( **You’ll need to have Node >= 6.10.3 on your machine**  [node.js](https://nodejs.org/)).
...
- [Lazy load bundle example](#Lazy-load-bundle-example)
  ...
  src/
    ...
    modules/
      moduleName/
        __tests__/
        ModuleName.js
        ModuleNameContainer.js
      moduleName2/
        __tests__/
        ModuleName2.js
        ModuleNameContainer2.js
    reducers/
    routes/
    store/
    styles/
